...
func _ready() -> void:
	...
	beach.material = load(bounce_shine_shader)
	...
	volcano.material.set_shader_parameter("time_offset", 1.0)
	
	electro.texture_normal = load("res://resources/buttons/locked_world_icon.tres")
	electro.material = load(bounce_shine_shader)
	...
	electro.material.set_shader_parameter("time_offset", 2.0)
